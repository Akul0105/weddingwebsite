  ...
  return (
    <main className="min-h-screen bg-gray-50">
            ...
            <div>
              ...
              >
                <div className="flex items-center gap-1">
                  ...
                  <span className="font-semibold">{djData.rating}</span>
                  <span className="text-pink-200">({djData.reviews} reviews)</span>
                </div>
                <div className="flex items-center gap-1">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">{djData.description}</p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {djData.specialties.map((specialty) => (
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm">{djData.experience} experience</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Users className="w-5 h-5 text-pink-600" />
                      <span className="text-sm">{djData.reviews} reviews</span>
                    </div>
                    <div className="flex items-center gap-3">
        ...
        {activeTab === 'portfolio' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {djData.portfolio.map((image, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
        ...
        {activeTab === 'contact' && (
          <div>
            <h2 className="text-3xl font-bold mb-8">Contact {djData.name}</h2>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span>{djData.rating} rating ({djData.reviews} reviews)</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Award className="w-5 h-5 text-pink-600" />

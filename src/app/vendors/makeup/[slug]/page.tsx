  ...
  return (
    <main className="min-h-screen bg-gray-50">
            ...
            <div>
              ...
              >
                <div className="flex items-center gap-1">
                  ...
                  <span className="font-semibold">{makeupData.rating}</span>
                  <span className="text-pink-200">({makeupData.reviews} reviews)</span>
                </div>
                <div className="flex items-center gap-1">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">{makeupData.description}</p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {makeupData.specialties.map((specialty) => (
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm">{makeupData.experience} experience</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Users className="w-5 h-5 text-pink-600" />
                      <span className="text-sm">{makeupData.reviews} reviews</span>
                    </div>
                    <div className="flex items-center gap-3">
        ...
        {activeTab === 'portfolio' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {makeupData.portfolio.map((image, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
        ...
        {activeTab === 'contact' && (
          <div>
            <h2 className="text-3xl font-bold mb-8">Contact {makeupData.name}</h2>
                  ...
                  <form onSubmit={handleContactSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        required
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                        placeholder="Tell us about your beauty vision..."
                      ></textarea>
                    </div>
                    <Button type="submit" className="w-full bg-pink-600 hover:bg-pink-700">
                      Send Message
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span>{makeupData.rating} rating ({makeupData.reviews} reviews)</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Award className="w-5 h-5 text-pink-600" />
                      <span>{makeupData.experience} experience</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
